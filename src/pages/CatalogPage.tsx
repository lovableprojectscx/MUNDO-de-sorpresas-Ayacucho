...
const CatalogPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative overflow-hidden flex flex-col items-center justify-center pt-16 pb-8 sm:pt-24 sm:pb-20 px-4 bg-background">
        ...
        <div className="relative z-10 container max-w-4xl mx-auto text-center pt-2 sm:pt-10">
          ...
          <motion.div
            ...
            className="max-w-4xl mx-auto bg-white/60 backdrop-blur-md border border-white/80 rounded-[1.5rem] sm:rounded-[2.5rem] p-4 sm:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.1)] relative overflow-hidden"
          >
            ...
            <div className="relative z-10">
              ...
              <h1 className="font-display text-2xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-slate-800 mb-2 sm:mb-6 drop-shadow-sm leading-tight">
